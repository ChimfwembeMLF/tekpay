...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Handle MTN webhook' }),
...
], WebhooksController.prototype, "handleMtnWebhook", null);
__decorate([
    (0, common_1.Post)('airtel'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    (0, swagger_1.ApiOperation)({ summary: 'Handle Airtel webhook' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Webhook processed successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid webhook data' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Headers)('x-signature')),
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], WebhooksController.prototype, "handleAirtelWebhook", null);
